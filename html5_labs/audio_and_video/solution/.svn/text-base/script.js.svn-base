...
$(document).ready(function(){
    ...
    if(!!$('<video/>')[0].play){
        ...
        // TODO: Change the speed of the video to be the selected new value
        ...
        $speedSelector.change(function(e){    
            $video[0].playbackRate = e.target.value;
        });
        ...
        // TODO: If the video is playing change the text of the button to be "play"
        ...
        // TODO: Check when the video is ended so you change the value of the toggle button
        ...
        // TODO: Listen out for a change to the volume slider and update video volume accordingly
        // IMPORTANT NOTE FOR JQUERY: the video DOM object can be accessed with $video[0]
